...
def find_best_binders(data):
    ...
    fitness_base=data.Interaction_Energy.mean()
...
def generate_FOLDX_mutate_runfiles_pos2(originalPDB,position):
    ...
    with open(temp_file,'w',newline='\n') as configfile:
                text_list_config = ["command=BuildModel\n","pdb="+originalPDB+"\n",
                    "pdb-dir=/home/krinad/thesisfiles/hsp70/buildmodel_AlanineMutagenesis/hillclimb2/\n",
                    "rotabaseLocation=/home/krinad/thesisfiles/hsp70/rotabase.txt\n",
                    "mutant-file=/home/krinad/thesisfiles/hsp70/buildmodel_AlanineMutagenesis/hillclimb2/pos"+str(position)+"/individual_list.txt\n",
                    "output-dir=/home/krinad/thesisfiles/hsp70/buildmodel_AlanineMutagenesis/hillclimb2/pos"+str(position)+"\n"]
    ...
    with open(temp_file_q,'w',newline='\n') as qfile:
        text_list_q = ["#!/bin/bash\n",
                       ...
                       "#$ -l h_vmem=256M\n",
                       "\n",
                       "/switchlab/group/tools/2021_FoldX5_LoopX/foldx -f /home/krinad/thesisfiles/hsp70/buildmodel_AlanineMutagenesis/hill_climb2/pos"+str(position)+"/"+temp_file+"\n"]
...
def generate_FOLDX_analyse_runfiles_pos2(originalPDB, position):
    ...
    with open(temp_file,'w',newline='\n') as configfile:
        text_list_config = ["command=AnalyseComplex\n","pdb-list=/home/krinad/thesisfiles/hsp70/buildmodel_AlanineMutagenesis/hillclimb2/pos"+str(position)+"/pdb-list.txt\n",
            "rotabaseLocation=/home/krinad/thesisfiles/hsp70/rotabase.txt\n",
            "analyseComplexChains=A,C\n",
            "output-dir=/home/krinad/thesisfiles/hsp70/buildmodel_AlanineMutagenesis/hillclimb2/pos"+str(position)+"/analyse/\n"]
        configfile.writelines(text_list_config)
        configfile.close()
    ...
    with open(temp_file_q,'w',newline='\n') as qfile:
        text_list_q = ["#!/bin/bash\n",
                       ...
                       "#$ -l h_vmem=256M\n",
                       "\n",
                       "/switchlab/group/tools/2021_FoldX5_LoopX/foldx -f /home/krinad/thesisfiles/hsp70/buildmodel_AlanineMutagenesis/hillclimb2/pos"+str(position)+"/config_analyse_pos"+str(position)+"_pdb_"+"original"+"_hsp70.cfg\n"]
        qfile.writelines(text_list_q)
        qfile.close()
    temp_file="pdb-list.txt"
    with open(temp_file,'w',newline='\n') as pdbfile:
            for j in range(1,21):
                pdbfile.write("/home/krinad/thesisfiles/hsp70/buildmodel_AlanineMutagenesis/hillclimb2/pos"+str(position)+"/"+"4po2AC_Repair_"+str(j)+".pdb;\n")
            pdbfile.close()
...
def generate_FOLDX_mutate_runfiles(data,position):
    for i in range(0,len(data)):
            ...
            with open(temp_file,'w',newline='\n') as configfile:         
                ...
                text_list_config = ["command=BuildModel\n","pdb="+data.iloc[i,0][2:]+"\n",
                    "pdb-dir=/home/krinad/thesisfiles/hsp70/buildmodel_AlanineMutagenesis/hillclimb2/pos"+str(position-1)+"\n",
                    "rotabaseLocation=/home/krinad/thesisfiles/hsp70/rotabase.txt\n",
                    "mutant-file=/home/krinad/thesisfiles/hsp70/buildmodel_AlanineMutagenesis/hillclimb2/pos"+str(position)+"/individual_list.txt\n",
                    "output-dir=/home/krinad/thesisfiles/hsp70/buildmodel_AlanineMutagenesis/hillclimb2/pos"+str(position)+"\n"]
                configfile.writelines(text_list_config)
    ...
    for i in range(0,len(data)):
        ...
        with open(temp_file_q,'w',newline='\n') as qfile:
            text_list_q = ["#!/bin/bash\n",
                            ...
                            "#$ -l h_vmem=512M\n",
                            "\n",
                            "/switchlab/group/tools/2021_FoldX5_LoopX/foldx -f /home/krinad/thesisfiles/hsp70/buildmodel_AlanineMutagenesis/hillclimb2/pos"+str(position)+"/config_mutate_pos"+str(position)+"_pdb_"+str(data.Pdb[i][16:len(data.Pdb[i])-4])+"_hsp70.cfg"+"\n"]
            qfile.writelines(text_list_q)
            qfile.close()
            ...
            for i in range(0,len(data)):
                    ...
                    with open(temp_file_q,'w',newline='\n') as qfile:
                        text_list_q = ["#!/bin/bash\n",
                                       ...
                                       "#$ -l h_vmem=2G\n",
                                       "\n",
                                       "/switchlab/group/tools/2021_FoldX5_LoopX/foldx -f /home/krinad/thesisfiles/hsp70/buildmodel_AlanineMutagenesis/hillclimb2/pos"+str(position)+"/config_analyse_pos"+str(position)+"_pdb_"+str(data.Index_made[i])+"_hsp70.cfg\n"]
                        qfile.writelines(text_list_q)
                        qfile.close()
...
def generate_FOLDX_analyse_runfiles_mod(data,position):
    ...
    with open(temp_file_q,'w',newline='\n') as qfile:
        text_list_q = ["#!/bin/bash\n",
                       ...
                       "#$ -l h_vmem=512M\n",
                       "\n",
                       "/switchlab/group/tools/2021_FoldX5_LoopX/foldx -f /home/krinad/thesisfiles/hsp70/buildmodel_AlanineMutagenesis/hillclimb2/pos"+str(position)+"/config_analyse_pos"+str(position)+"_pdb_all_hsp70.cfg\n"]
        qfile.writelines(text_list_q)
        qfile.close()
    temp_file="pdb-list.txt"
    with open(temp_file,'w',newline='\n') as pdbfile:
        for i in data.Pdb:
            for j in range(1,21):
                pdbfile.write("/home/krinad/thesisfiles/hsp70/buildmodel_AlanineMutagenesis/hillclimb2/pos"+str(position)+"/"+i[2:len(i)-4]+"_"+str(j)+".pdb;\n")
    pdbfile.close()
...
def find_substate_name_432567(file,sequence,length_of_substrate):
    seq=list(sequence)
    substrate=['A']*length_of_substrate
    temp=file[:-4].split("_")[2:]
    for i in range(0,len(temp)):
        substrate[int(seq[i])-1]=aa[int(temp[i])-1]
    return("".join(substrate)[1:])
...
# top_20_2=find_top_X(data,20)
# peptides_data2=return_top_X_peptides(top_20_2,6)
...
# top_20_3=find_top_X(data3,20)
# peptides_data3=return_top_X_peptides(top_20_3,6)
...
# top_20_4=find_top_X(data4,20)
# peptides_data4=return_top_X_peptides(top_20_4,6)
...
# top_20_5=find_top_X(data5,20)
# peptides_data5=return_top_X_peptides(top_20_5,6)
...
# top_20_6=find_top_X(data6,20)
# peptides_data6=return_top_X_peptides(top_20_6,6)
...
#################
# # STARTING AT POSITION  4-3-2-5-6-7
## position 4

#create_indlist("C", 4)
#generate_FOLDX_mutate_runfiles_pos2("4po2AC_Repair.pdb",4)
#generate_FOLDX_analyse_runfiles_pos2("4po2AC_Repair.pdb",4)

data4=readSummary("C:\\Users\\user\\Desktop\\hill_climbing\\four-three-two-five-six-seven\\four\\Summary_file_pos4.txt")
find_next=find_best_binders(data4)
...
data3=readSummary("C:\\Users\\user\\Desktop\\hill_climbing\\four-three-two-five-six-seven\\three\\Summary_file_pos3.txt")
find_next=find_best_binders(data3)

## position 2
#create_indlist("C", 2)     
#generate_FOLDX_mutate_runfiles(find_next, 2) 
#generate_FOLDX_analyse_runfiles_mod(find_next,2)  

data2=readSummary("C:\\Users\\user\\Desktop\\hill_climbing\\four-three-two-five-six-seven\\two\\Summary_file_pos2.txt")
find_next=find_best_binders(data2)

## position 5
#create_indlist("C", 5)   
#generate_FOLDX_mutate_runfiles(find_next, 5) 
#generate_FOLDX_analyse_runfiles_mod(find_next,5)  
data5=readSummary("C:\\Users\\user\\Desktop\\hill_climbing\\four-three-two-five-six-seven\\five\\Summary_file_pos5.txt")
find_next=find_best_binders(data5)
...
#generate_FOLDX_mutate_runfiles(find_next, 6) 
#generate_FOLDX_analyse_runfiles_mod(find_next,6)
data6=readSummary("C:\\Users\\user\\Desktop\\hill_climbing\\four-three-two-five-six-seven\\six\\Summary_file_pos6.txt")
find_next=find_best_binders(data6)

## position 7
#create_indlist("C", 7)   
#generate_FOLDX_mutate_runfiles(find_next, 7) 
#generate_FOLDX_analyse_runfiles_mod(find_next,7)
data7=readSummary("C:\\Users\\user\\Desktop\\hill_climbing\\four-three-two-five-six-seven\\seven\\Summary_file_pos7.txt")
find_next=find_best_binders(data7)


with open("peptides_best7.txt",'w',newline='\n') as best_peptide_file:
    for i in range(0,len(find_next.Pdb)):
        best_peptide_file.write(find_substate_name_432567(find_next.Pdb[i],"432567",7)+"\n")
